...
func main() {
	if err := run(); err != nil {
		_, err := fmt.Fprintf(os.Stderr, "document-service: %v\n", err)
		if err != nil {
			return
		}
		os.Exit(1)
