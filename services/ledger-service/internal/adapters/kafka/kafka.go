// Package kafka — исходящая шина ledger-service: сюда складываются доменные
// события, которые сервис публикует наружу (проведённая проводка, отклонённая проводка). Знания о gRPC и о
...
const source = "ledger-service"

// Producer публикует события ledger-service в Kafka.
//
