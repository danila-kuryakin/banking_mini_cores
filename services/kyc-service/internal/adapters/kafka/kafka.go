// Package kafka — исходящая шина kyc-service: сюда складываются доменные
// события, которые сервис публикует наружу (подача анкеты, одобрение, отказ). Знания о gRPC и о
...
const source = "kyc-service"

// Producer публикует события kyc-service в Kafka.
//
